...
urlpatterns = [
    ...
    re_path(
        r"^library/search/cover-image/$",
        login_required(SearchCoverImage.as_view(), login_url="/login/"),
        name="viveca_dashboard_search_cover_image",
    ),
    re_path(
        r"^podcasts/$",
    ...
    re_path(
        r"^ai-voicetracks/generate-audio/$",
        login_required(AiVoicetracksGenerateAudioView.as_view(), login_url="/login/"),
        name="viveca_dashboard_ai_voicetracks_generate_audio",
    ),
    re_path(
