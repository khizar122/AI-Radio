...
let wavesurfer = null;
let wsRegions = null;
let waveform_toggle_button = null;
...
function createWaveformButton() {
  ...
  waveform_toggle_button = document.getElementById('waveform_toggle_button');
  waveform_toggle_button.addEventListener('click', handleButtonClick);
  waveform_toggle_button.disabled = false;
}

function destroyOldWaveform() {
  document.getElementById('waveform').innerHTML = '';
  wavesurfer = null;
  wsRegions = null;
  waveform_toggle_button.removeEventListener('click', handleButtonClick);
  waveform_toggle_button.disabled = true;
}
