...
class Library(models.Model):
    ...
    media = models.URLField(_("Media URL"), max_length=500)
    lyrics = models.URLField(_("Lyrics URL"), max_length=500, blank=True, null=True)
    # cover = models.URLField(_("Cover URL"))
